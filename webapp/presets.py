...
PRESETS: tuple[Preset, ...] = (
    ...
    Preset(key='prompt/audio-only', folder='YT-DLP-prompt', label='prompt-audio-only',
           params=DriverParams(script=DRIVER_SCRIPT, mode='only-audio', cookies=COOKIES_FROM_CONFIG,
                               notifications='NO')),
    Preset(key='prompt/video-only', folder='YT-DLP-prompt', label='video-only',
           params=DriverParams(script=DRIVER_SCRIPT, mode='video-only', subs=True,
                               video_timeout=1800, cookies=COOKIES_FROM_CONFIG,
                               notifications='NO')),
    Preset(key='prompt/video-only-rerun', folder='YT-DLP-prompt', label='video-only w/rerun',
           params=DriverParams(script=DRIVER_SCRIPT, mode='video-only', subs=True,
